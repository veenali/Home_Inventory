...
{  
   ...
   JButton newButton = new JButton(new ImageIcon("newbutton.jpeg")); 
   JButton deleteButton = new JButton(new ImageIcon("delete.jpeg"));  
   JButton saveButton = new JButton(new ImageIcon("save.jpeg")); 
   JButton previousButton = new JButton(new ImageIcon("previous.jpeg")); 
   JButton nextButton = new JButton(new ImageIcon("next.jpeg")); 
   JButton printButton = new JButton(new ImageIcon("print.jpeg")); 
   JButton exitButton = new JButton();
   
   Dimension bSize = new Dimension(60, 70);
   ...
   JLabel datemonthyearLabel = new JLabel();
  ...
  dateTextField.setPreferredSize(new Dimension(90,25));
  gridConstraints = new GridBagConstraints();
  gridConstraints.gridx = 5;
  gridConstraints.gridy = 3;
  gridConstraints.gridwidth = 2;
  ...
  dateTextField.addActionListener(new ActionListener()
  {
	  public void actionPerformed(ActionEvent e)
	  {
		  dateTextFieldActionPerformed(e);
      }
  });
  
  datemonthyearLabel.setText("(DD-MM-YYYY)");
  datemonthyearLabel.setFont(new Font("Arial",Font.ITALIC|Font.BOLD,10));
  gridConstraints = new GridBagConstraints();
  gridConstraints.gridx = 6;
  gridConstraints.gridy = 3;
  gridConstraints.insets = new Insets(10, 10, 0, 10);
  gridConstraints.anchor = GridBagConstraints.CENTER;
  getContentPane().add(datemonthyearLabel, gridConstraints);
  ...
  int x = 0, y = 0; // create and position 26 buttons 
  for (int i = 0; i < 26; i++) 
  { // create new button 
  ...
  private void showEntry(int j) 
  {
	  ...
	  dateTextField.setText(myInventory[j-1].purchaseDate);
  ...
  {
	  if(!validateDecimalNumber(dateTextField))
	  {
		  dateTextField.setText("");
		  JOptionPane.showConfirmDialog(null, "INVALID DATE ENTRY.\nPLEASE FILL IN THE CORRECT DATE", "Input Error", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE); 
  ...
  private String dateToString(Calendar dd) 
  {
	  dd = Calendar.getInstance();
	  String yString = String.valueOf(dd.get(Calendar.YEAR) + 1900); 
	  int m = dd.get(Calendar.MONTH) + 1; 
	  String mString = new DecimalFormat("00").format(m); 
	  int d = dd.get(Calendar.DATE); 
  ...
  private void checkSave() 
  {
	  ...
	  else if (!myInventory[currentEntry - 1].purchaseDate.equals(dateTextField.getText()))
		  edited = true;
  ...
  private void blankValues() 
  {
	  ...
	  dateTextField.setText(""); 
	  storeTextField.setText(""); noteTextField.setText(""); 
      photoTextArea.setText(""); 
	  photoPanel.repaint(); 
	  itemTextField.requestFocus();
  } 
  ...
  private void saveButtonActionPerformed(ActionEvent e)
  {
	  ...
	  {
		  dateTextField.setText("");
		  JOptionPane.showConfirmDialog(null, "INVALID DATE ENTRY.", "Input Error", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE); 
	      dateTextField.requestFocus();
	  }  
	  ...
	  myInventory[currentEntry - 1].purchaseDate = dateTextField.getText();
  ...
  private void dateTextFieldActionPerformed(ActionEvent e) 
  {
  ...
  {
	  // checks to see if text field contains valid decimal number with only digits  
      ...
      {    
		  ...
		  {
                tf.setText("");
				JOptionPane.showConfirmDialog(null, "INVALID DATE ENTRY", "ERROR", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
          }	
  ...
  { 
   ...
   {
	    JOptionPane.showConfirmDialog(null,"ERROR IN WRITING IN FILE.\nPLEASE TRY AGAIN","ERROR",JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
   }
	System.exit(0); 
  }
...
class InventoryDocument implements Printable 
{
	public int print(Graphics g, PageFormat pf, int pageIndex) 
	{
		...
		for (i = 0 + HomeInventory.entriesPerPage * pageIndex; i < iEnd; i++) 
		{
			...
			y += dy; g2D.setFont(new Font("Arial", Font.PLAIN, 12)); 
